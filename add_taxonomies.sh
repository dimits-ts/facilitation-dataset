#!/bin/bash
python scripts/taxonomy_annotate.py --mod_probability_file=output_datasets/pefk_mod.csv --dataset_file=pefk.csv --taxonomy_file=taxonomies/config/ta
xonomy.yaml --prompt_file=taxonomies/config/prompt.json --output_dir=taxonomies/output --m
